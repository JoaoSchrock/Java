...
public class OperadoresRelacionais {
    public static void main(String[] args) {
        ...
        //    * O Java só consegue comparar os tipos Wrappers, através do operador "==", com números que
        //	estão no intervalo de "-128" até "127". Fora desse intervalo, o operador "==" pode causar muita
        //  confusão quando utilizado com os tipos Wrappers. Utilizado juntamente com os primitivos (que,
        ...
        //  Wrappers. Isso porque o valor de uma variável sempre será igual a ele mesmo. Repare que, em nosso
