...
public class Exercicio04 {
    static final Integer NUMEROSDAMULTIPLICACAO = 20;
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < NUMEROSDAMULTIPLICACAO;i++){
    ...
    static final Integer imprimirTraco() {
        System.out.println("-----------------");
        return null;
    }

    static final Integer titulo() {
        System.out.println("TABUADA DE 0 A 20 ");
        imprimirTraco();
        return null;
    }

    static final Integer observacoesFinais(){
        System.err.println("Usei o (for) na multiplicação\npois não consegui\ncolocar o calculo\ndentro de um metodo.");
        System.out.println("OBS:CODIGO INCOMPLETO:");
        return  null;
    }
